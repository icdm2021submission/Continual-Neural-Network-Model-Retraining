...
if __name__ == '__main__':
    ...
    if params.num_learners <= 1:# not args.retrain or args.combine:
        ...
        if args.finetune:
            npy_vars_weights1_1 = np.load('cluster_array_weights1_1.npy')
            # npy_vars = np.reshape(npy_vars, shape)
            npy_vars_weights1_2 = np.load('cluster_array_weights1_2.npy')
            npy_vars_weights3_1 = np.load('cluster_array_weights3_1.npy')
            npy_vars_weights3_2 = np.load('cluster_array_weights3_2.npy')
