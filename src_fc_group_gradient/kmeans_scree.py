...
weight_names = ['weights1_2'] # 'weights1_1', 'weights1_2', 'weights3_1', 'weights3_2'
...
def plot(num_clusters, distortions):
    x = range(1, 21)
    plt.clf()
    plt.plot(x, distortions, marker='o', linewidth=2, alpha=0.5)
    ...
    plt.savefig('SEA_scree_cluster_weights1_2.pdf')
