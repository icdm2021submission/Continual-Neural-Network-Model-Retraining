...
if __name__ == '__main__':
    ...
    if args.combine:
        ...
        # Create the input data pipeline
        logging.info("Creating the datasets...")
        print('glob.glob(path_train_tfrecords): {} ~~~~~~'.format(glob.glob(path_train_tfrecords)))
        train_dataset = load_dataset_from_tfrecords(glob.glob(path_train_tfrecords))
    ...
    logging.info('params.train_size: {}'.format(params.train_size))
    ...
    npy_vars_weights1_1, npy_vars_weights1_2, npy_vars_weights3_2 = [], [], []
    if args.finetune:
    ...
    npy_vars = [npy_vars_weights1_1, npy_vars_weights1_2, npy_vars_weights3_2]    
