...
for i in range(5, 10):
	train_script = 'CUDA_VISIBLE_DEVICES={} python main.py --train_range [0-{}] \
	...
	test_fake_script = 'python evaluate.py --train_range [0-{}] \
	...
	# if args.use_kfac:
	# 	continue
	# collect_script = 'CUDA_VISIBLE_DEVICES={} python collect.py --train_range [0-{}] \
	#  --loss_fn cnn --log _{}'.format(args.gpu, i, args.log)
