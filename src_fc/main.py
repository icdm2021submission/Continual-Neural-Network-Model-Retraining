...
parser.add_argument('--use_bn', default=False, type=lambda x: (str(x).lower() in ['true','1', 'yes']), \
    help="use_bn")
parser.add_argument('--training_keep_prob', default=1.0, help="training_keep_prob")
...
if __name__ == '__main__':
    ...
    params.dict['use_bn'] = args.use_bn
    params.dict['training_keep_prob'] = float(args.training_keep_prob)
