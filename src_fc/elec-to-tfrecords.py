...
def convert_to_tf_record(data_directory:str, dataset_name:str):
    ...
    num_validation_examples, depth = convert_to(cifar10_train, 'validation', data_directory, mean, std, num_shards=10)
    num_test_examples, depth = convert_to(cifar10_test, 'test', data_directory, mean, std, num_shards=10)
