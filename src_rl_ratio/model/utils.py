...
def cal_sample_size(params_train_size, args_sample_train_ratio):
    '''
    args_train_range should be a percentage, e.g., 5, 10, 20, 50
    '''
    # calculate actual train size
    current_train_size = params_train_size * float(args_sample_train_ratio) / 100
