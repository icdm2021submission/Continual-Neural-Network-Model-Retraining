...
def convert_to_tf_record(data_directory:str):
    ...
    num_validation_examples, rows, cols, depth = convert_to(mnist.validation, 'validation', data_directory, mean, std)
    num_train_examples, rows, cols, depth = convert_to(mnist.train, 'train', data_directory, mean, std, num_shards=10)
    num_test_examples, rows, cols, depth = convert_to(mnist.test, 'test', data_directory, mean, std)
