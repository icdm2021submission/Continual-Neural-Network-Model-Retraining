...
# python main.py --train_range [5-6] --loss_fn retrain_regu_fisher --finetune true
...
for i in range(5, 10):
	train_script = 'CUDA_VISIBLE_DEVICES={} python main.py --train_range [{}-{}] \
	 --loss_fn {} --finetune true --use_kfac {} --log _{} --data_dir {}'.format(args.gpu, i-1, i, args.loss_fn, \
	...
	test_fake_script = 'python evaluate.py --train_range [{}-{}] \
	 --loss_fn {} --finetune true --use_kfac {} --log _{} --data_dir {}'.format(i-1, i, args.loss_fn, \
	 	args.use_kfac, args.log, args.data_dir)
	...
	collect_script = 'CUDA_VISIBLE_DEVICES={} python collect.py --train_range [{}-{}] \
	 --loss_fn cnn --log _{} --data_dir {}'.format(args.gpu, i-1, i, args.log, args.data_dir)
